...
class Player:
    ...
    def setAnimationClips(self):
        self.idleAnimation = Animator("Prototyping/Coach/playerIdleFrames",[32,64],"Idle")
        self.runAnimation = Animator("Prototyping/Coach/playerRunFrames",[48,64],"Run")
        self.runAnimation.animationSpeed = 2
        self.jumpAnimation = Animator("Prototyping/Coach/playerJumpFrames",[48,64],"Jump",loop = False)
        self.fallAnimation = Animator("Prototyping/Coach/playerFallFrames",[48,64],"Fall",loop = False)
        self.attackAnimation = Animator("Prototyping/Coach/playerAttackFrames0",[64,72],"Attack",loop = False)
        self.attackAnimation.animationSpeed = 2
        self.jumpAttackAnimation = Animator("Prototyping/Coach/playerAttackFrames1",[64,72],"Jump_Attack",loop = False)
        self.jumpAttackAnimation.animationSpeed = 1
        self.slideAnimation = Animator("Prototyping/Coach/playerSlidingFrames",[48,48],"Slide",loop = False)
