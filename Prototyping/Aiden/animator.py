...
if __name__ == "__main__":
    ...
    idle = Animator("Prototyping/Aiden/playerIdleFrames", 10, [48, 64], "Idle")
    idleRect = pygame.Rect(15, 15, 48, 64)

    run = Animator("Prototyping/Aiden/playerRunFrames", 10, [48, 64], "Run")
    run.animationSpeed = 5
    runRect = pygame.Rect([15, 100, 48, 64])

    jump = Animator("Prototyping/Aiden/playerJumpFrames", 7, [48, 64], "Jump")
    jump.animationSpeed = 1
