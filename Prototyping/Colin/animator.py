...
if __name__ == "__main__":
    ...
    idle = Animator("Prototyping\Colin\playerIdleFrames", 10, [48, 64], "Idle")
    idleRect = pygame.Rect(15, 15, 48, 64)

    run = Animator("Prototyping\Colin\playerRunFrames", 10, [48, 64], "Run")
    run.animationSpeed = 2
    runRect = pygame.Rect(15, 100, 48, 64)

    jump = Animator("Prototyping\Colin\playerJumpFrames", 7, [48, 64], "Jump")
