...
class Animator:
    ...
    def __init__(self,folderPath,numOfFrames,size,name,loop = True):
        ...
        for i in range(numOfFrames):
            ...
            image = pygame.transform.scale(image,[275,400])
...
if __name__ == "__main__":
    ...
    idle = Animator("CoachMaster/playerIdleFrames",10,[48,64],"Idle")
    idleRect = pygame.Rect(15,15,48,64)

    run = Animator("CoachMaster/playerRunFrames",10,[48,64],"Run")
    run.animationSpeed = 2
    runRect = pygame.Rect(15,100,48,64)

    jump = Animator("CoachMaster/playerJumpFrames",7,[48,64],"Jump")
    jumpRect = pygame.Rect(15,175,48,64)

    fall = Animator("CoachMaster/playerFallFrames",3,[48,64],"Fall")
